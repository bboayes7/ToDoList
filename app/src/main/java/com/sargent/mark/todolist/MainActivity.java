...
public class MainActivity extends AppCompatActivity implements AddToDoFragment.OnDialogCloseListener, UpdateToDoFragment.OnUpdateDialogCloseListener{
    ...
    protected void onStart() {
        ...
        adapter = new ToDoListAdapter(cursor, new ToDoListAdapter.ItemClickListener() {
            ...
            @Override
            public void onItemClick(int pos, String description, String duedate, long id, String category, Integer done) {
    ...
    @Override
    public void closeDialog(int year, int month, int day, String description, String category, Integer done) {
    ...
    private long addToDo(SQLiteDatabase db, String description, String duedate, String category, Integer done) {
        Log.d(TAG, "QUERY: " + description + ", " + duedate + ", " + category + ", " + done);
    ...
    @Override
    public void closeUpdateDialog(int year, int month, int day, String description, long id, String category, Integer done) {
